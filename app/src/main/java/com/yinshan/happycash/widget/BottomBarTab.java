...
public class BottomBarTab extends FrameLayout {
    ...
    private void init(Context context, int icon, CharSequence title) {
        ...
        mIcon.setColorFilter(ContextCompat.getColor(context, R.color.hc_button_d));
        ...
        mTvTitle.setTextColor(ContextCompat.getColor(context, R.color.hc_button_d));
    ...
    public void setSelected(boolean selected) {
        ...
        if (selected) {
            mTvTitle.setTextColor(ContextCompat.getColor(mContext, R.color.hc_input_text));
        } else {
            mTvTitle.setTextColor(ContextCompat.getColor(mContext, R.color.hc_button_d));
        }
    }
